    ...
    <div class="uk-container uk-container-large">
        <div class="uk-grid-margin" uk-grid>
            <div class="uk-width-1-1@m">
                ...
                <h5>Logged on: {{Auth::user()->updated_at}}</h5>
                <h4>Pick one of the tasks below. </h4>
                <div uk-slider class="uk-margin-small uk-text-center">
