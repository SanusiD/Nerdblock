...
<div class="uk-section-default uk-section">
    <div class="uk-container uk-container-large">
                ...
                <div class="uk-position-relative">
                    <div class="uk-slider-container">
                        ...
                        <li class="el-item uk-width-4-5 uk-width-1-3@m uk-width-3-5@l">
                            ...
                            tabindex="0" href="/nerdblock/index.php/store">
        ...
        <li class="el-item uk-width-4-5 uk-width-1-3@m uk-width-3-5@l">
            ...
            tabindex="0" href="/nerdblock/index.php/store">
            <div
            class="uk-position-cover uk-transition-scale-up uk-transition-opaque">
        ...
        <div class="uk-margin">
            <div class="uk-child-width-1-2 uk-child-width-1-3@m uk-grid-match" uk-grid>
                ...
                <div>
                    ...
                    href="/product/{{$block-> blockID}}">
                    @if($block->blockTheme =='horror') 
                    <img class="el-image" alt                                     
                    data-src="images\horror.png"
                    data-srcset="images\horror.png"
